...
# -*- coding: utf-8 -*-
"""
Created on Tue May 26 13:30:00 2020
...
# Load in big datasets
movies = pd.read_csv('ml-1m/movies.dat', sep = '::', header = None, engine = 'python', encoding = 'latin-1')
users = pd.read_csv('ml-1m/users.dat', sep = '::', header = None, engine = 'python', encoding = 'latin-1')
ratings = pd.read_csv('ml-1m/ratings.dat', sep = '::', header = None, engine = 'python', encoding = 'latin-1')

#Preparing test and training set using older 100k data
...
# Create list of lists required by pytorch to create a tensor
def convert(data):
    new_data = []
...
#make the movie ratings binary classifications
